...
-- Schema green_valley
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `green_valley` ;
USE `green_valley` ;
-- -----------------------------------------------------
-- Table `green_valley`.`Ward`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Ward` (
  `Ward_Number` INT NOT NULL,
  `Ward_Name` VARCHAR(45) NOT NULL,
  `Ward_Location` VARCHAR(45) NULL,
  `Bed_Count` INT NULL,
  `Extenstion_Number` VARCHAR(45) NULL,
  PRIMARY KEY (`Ward_Number`),
  UNIQUE INDEX `Ward_Number_UNIQUE` (`Ward_Number` ASC) VISIBLE)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Patient`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Patient` (
  ...
  `Ward_Number` INT NOT NULL,
  PRIMARY KEY (`Patient_Number`, `Ward_Number`),
  UNIQUE INDEX `Patien_Number_UNIQUE` (`Patient_Number` ASC) VISIBLE,
  INDEX `fk_Patient_Ward_idx` (`Ward_Number` ASC) VISIBLE,
  CONSTRAINT `fk_Patient_Ward`
    FOREIGN KEY (`Ward_Number`)
    REFERENCES `green_valley`.`Ward` (`Ward_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Supplier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Supplier` (
  ...
  UNIQUE INDEX `Supplier_Number_UNIQUE` (`Supplier_Number` ASC) VISIBLE)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Supply`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Supply` (
  `Supply_Number` INT NOT NULL,
  `Supply_Name` VARCHAR(45) NULL,
  `Description` VARCHAR(255) NULL,
  `Dosage` VARCHAR(45) NULL,
  `Method_Of_Administration` VARCHAR(45) NULL,
  `Quantity_In_Stock` INT NULL,
  `Reorder_Level` INT NULL,
  `Cost_Per_Unit` FLOAT NULL,
  `Type_Of_Supply` VARCHAR(45) NULL,
  `Supplier_Number` INT NOT NULL,
  PRIMARY KEY (`Supply_Number`, `Supplier_Number`),
  UNIQUE INDEX `Drug_Number_UNIQUE` (`Supply_Number` ASC) VISIBLE,
  INDEX `fk_Supply_Supplier1_idx` (`Supplier_Number` ASC) VISIBLE,
  CONSTRAINT `fk_Supply_Supplier1`
    FOREIGN KEY (`Supplier_Number`)
    REFERENCES `green_valley`.`Supplier` (`Supplier_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Medication`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Medication` (
  ...
  PRIMARY KEY (`Medication_Number`, `Patient_Number`, `Drug_Number`),
  UNIQUE INDEX `Medication_Number_UNIQUE` (`Medication_Number` ASC) VISIBLE,
  INDEX `fk_Medication_Patient1_idx` (`Patient_Number` ASC) VISIBLE,
  INDEX `fk_Medication_Pharmaceutical_Supply1_idx` (`Drug_Number` ASC) VISIBLE,
  CONSTRAINT `fk_Medication_Patient1`
    FOREIGN KEY (`Patient_Number`)
    REFERENCES `green_valley`.`Patient` (`Patient_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Medication_Pharmaceutical_Supply1`
    FOREIGN KEY (`Drug_Number`)
    REFERENCES `green_valley`.`Supply` (`Supply_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Staff` (
  `Staff_Number` INT NOT NULL,
  `Staff_Name` VARCHAR(45) NULL,
  `Qualification` VARCHAR(45) NULL,
  `Past_Experience` VARCHAR(45) NULL,
  `Ward_Number` INT NOT NULL,
  PRIMARY KEY (`Staff_Number`, `Ward_Number`),
  UNIQUE INDEX `Staff_Number_UNIQUE` (`Staff_Number` ASC) VISIBLE,
  INDEX `fk_Staff_Ward1_idx` (`Ward_Number` ASC) VISIBLE,
  CONSTRAINT `fk_Staff_Ward1`
    FOREIGN KEY (`Ward_Number`)
    REFERENCES `green_valley`.`Ward` (`Ward_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `green_valley`.`Requisition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `green_valley`.`Requisition` (
  `Requisition_Number` INT NOT NULL,
  `Quantity_Required` INT NULL,
  `Date_Of_Order` DATE NULL,
  `Delivery_Date` DATE NULL,
  `Charge_Nurse_Signature` VARCHAR(45) NULL,
  `Staff_Number` INT NOT NULL,
  `Ward_Number` INT NOT NULL,
  `Supply_Number` INT NOT NULL,
  PRIMARY KEY (`Requisition_Number`, `Staff_Number`, `Ward_Number`, `Supply_Number`),
  UNIQUE INDEX `Requisition_Number_UNIQUE` (`Requisition_Number` ASC) VISIBLE,
  INDEX `fk_Requisition_Staff1_idx` (`Staff_Number` ASC) VISIBLE,
  INDEX `fk_Requisition_Ward1_idx` (`Ward_Number` ASC) VISIBLE,
  INDEX `fk_Requisition_Supply1_idx` (`Supply_Number` ASC) VISIBLE,
  CONSTRAINT `fk_Requisition_Staff1`
    FOREIGN KEY (`Staff_Number`)
    REFERENCES `green_valley`.`Staff` (`Staff_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Requisition_Ward1`
    FOREIGN KEY (`Ward_Number`)
    REFERENCES `green_valley`.`Ward` (`Ward_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Requisition_Supply1`
